 ...
 * @author Liu lihua
 */
public class FilenamePatternConvertor extends PatternConvertor
{
    ...
    {
        if (message == null || message.getThrowableInfo() == null)
        {
            return false;
        }
        buf.append(message.getThrowableInfo().getSourceFile());
        return true;
    }
